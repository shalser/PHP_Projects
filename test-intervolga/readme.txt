...
https://shakhty.hh.ru/vacancy/42776431

PHP-разработчик / web-программист (стажер, junior)
от 20 000 руб. на руки

ИНТЕРВОЛГА
Волгоград, набережная 62-й Армии, 6

=======================================================
=======================================================

//todo Чтобы получить приглашение на собеседование, приложите к резюме ответы на вопросы:

//todo 1. PHP и HTML. Напишите код на PHP
...
//todo Может быть что последнее слово из двух обрежется и будет не законченное.
===================================================================

//todo 2. Веб-разработка
